...
function buildMetadata(sample) {
  ...
  let sampleArray=metadata.filter(sampleobject => sampleobject.id.toString() === sample.toString());
...
function buildCharts(sample) {
  ...
  let sampleArray=samples.filter(sampleObj => sampleObj.id.toString() === sample.toString());
  let sampleData=sampleArray[0];
